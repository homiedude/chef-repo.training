...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "haxalan-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/axalan"
  #   chef.validation_client_name = "axalan-validator"
  #   chef.validation_key_path = ".chef/axalan-validator.pem"
  # end
end
